...
function renderPrimaryInsight(summaries, settings, renderContext = true) {
...
function updateSummaryTargetHint() {
    const target = elements.contextStrip.querySelector("[data-summary-target]");
    if (!target) return;
